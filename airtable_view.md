...
- ThePrincetonHandbookforReproducibleNeuroimaging—ThePrincetonHandbookforReproducibleNeuroimaging(brainhack-princeton.github.io)
- BerkeleySpring2021-FullStackDeepLearning(google.com)
- "StanfordAILabPapersandTalksatNeurIPS2020
- ai.stanford.edu
- LearnableProgramming(worrydream.com)
...
- COMSW4995AppliedMachineLearningSpring2019-Schedule-AndreasC.Müller-AssociateResearchScientist(columbia.edu)
- sirredbeard/Awesome-WSL:AwesomelistdedicatedtoWindowsSubsystemforLinux(github.com)
- StudentDeveloperCompetitions|ImagineCup(microsoft.com)
- CS285(berkeley.edu)
- KeyPapersinDeepRL—SpinningUpdocumentation(openai.com)
...
- alvations/awesome-community-curated-nlp:CommunityCuratedNLPList(github.com)
...
- MLArt-Ashowcasewithcreativemachinelearningartworksandprojects
- https://ccrma.stanford.edu/~jos/mdft/
- https://github.com/n2cholas/awesome-jax
- MachineVisionStudyGuide—MachineVisionStudyGuide(k-state.edu)
...
- ScientificComputingforDPhilStudentsbyOxfordUniversityonApplePodcasts
- LinearOptimization(cmi.ac.in)
- ConvexOptimization(cmu.edu)
- http://videolectures.net/rldm2015_silver_reinforcement_learning/
- ConvexOptimization(cmu.edu)
- PrinciplesofOptimization-LectureNotesandVideos(wsu.edu)
- CS287Fall2019(berkeley.edu)
- Optimization(gsu.edu)
...
- ahmedbahaaeldin/From-0-to-Research-Scientist-resources-guide:DetailedandtailoredguideforundergraduatestudentsoranybodywanttodigdeepintothefieldofAIwithsolidfoundation.(github.com)
- http://en.tutiempo.net/climate
- http://groups.csail.mit.edu/vision/SUN/hierarchy.html
- http://ecg.mit.edu/time-series/
